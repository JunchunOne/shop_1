...
<h1>
        ...
        <form method="post" action="<?php echo U();?>">
            <table cellspacing="1" cellpadding="3" width="100%">
                <tr>
                    ...
                    <td>
                        <input type="text" name="username" maxlength="60" <?php if(!empty($id)): ?>disabled="disabled"<?php endif; ?> value="<?php echo ($username); ?>"/>
                    </td>
                ...
                <tr>
                    ...
                    <td>
                        <?php if(is_array($role)): foreach($role as $key=>$Val): ?><input type="checkbox" name="role_ids[]" class="role_ids" maxlength="60" value="<?php echo ($Val["id"]); ?>"><?php echo ($Val["name"]); endforeach; endif; ?>
                    </td>
                </tr>
                <tr>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            <?php if(!empty($id)): ?>var role_ids = <?php echo ($roler_id); ?>;
