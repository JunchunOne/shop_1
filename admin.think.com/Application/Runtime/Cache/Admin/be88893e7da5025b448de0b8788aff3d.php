    ...
    <div class="list-div" id="listDiv">
        ...
        <table cellpadding="3" cellspacing="1">
            ...
            <tr>
                ...
                <th>标题</th><th>文章分类</th><th>内容</th><th>浏览次数</th><th>录入时间</th><th>摘要</th><th>状态</th><th>排序</th>                <th>操作</th>
            </tr>
            <tr>
...
<td align='center'><?php echo ($list["article_category_id"]); ?></td>
<td align='center'><?php echo ($list["content"]); ?></td>
<td align='center'><?php echo ($list["times"]); ?></td>
<td align='center'><?php echo date("Y-m-d H:i:s",$list['inputtime']);?></td>
