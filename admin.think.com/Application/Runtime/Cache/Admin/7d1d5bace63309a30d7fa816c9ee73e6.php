    ...
    <div class="list-div" id="listDiv">
        ...
        <table cellpadding="3" cellspacing="1">
            ...
            <?php if(is_array($lists)): foreach($lists as $key=>$list): ?><tr>
                    ...
                    <td align='center'><?php echo ($list["sn"]); ?></td>
                    <td align='center'><?php echo ($list["goods_category_id"]); ?></td>
                    <td align='center'><?php echo ($list["brand_id"]); ?></td>
                    <td align='center'><?php echo ($list["supplier_id"]); ?></td>
                    <td align='center'><?php echo ($list["shop_price"]); ?></td>
                    <td align='center'><?php echo ($list["market_price"]); ?></td>
                    <td align='center'><?php echo ($list["stock"]); ?></td>
                    <td align='center'><?php echo ($list["is_on_sale"]); ?></td>
                    <td align='center'><?php echo ($list["goods_status"]); ?></td>
                    <td align='center'><?php echo ($list["keyword"]); ?></td>
