    ...
    <div class="list-div" id="listDiv">
        ...
        <table cellpadding="3" cellspacing="1">
            ...
            <foreach name="lists" item="list">
              ...
              if($val['field']=='status'){
              echo "<td align='center'><a  class='ajax_get' href='{:U('changStatus',array('id'=>\$list['id'],'status'=>1-\$list['status']))}'><img src='__IMG__/{\$list.{$val['field']}}.gif'/></a></td>\r\n";
              }else{
                   echo  "<td align='center'>{\$list.{$val['field']}}</td>\r\n";
                    }
                    }
                    ?>
                    <td align="center">
