...
<head>
	...
	<link rel="stylesheet" href="http://test.think.com/Application/Public/Home/css/goods.css" type="text/css">
	<link rel="stylesheet" href="http://test.think.com/Application/Public/Home/css/common.css" type="text/css">
	<link rel="stylesheet" href="http://test.think.com/Application/Public/Home/css/jqzoom.css" type="text/css">
		...
		<div class="goods_left fl">
			...
			<div class="related_view newgoods leftbar mt10">
				...
				<div class="leftbar_wrap">
					<ul>
						<li>
							<dl>
								<dt><a href=""><img src="http://test.think.com/Application/Public/Home/images/relate_view1.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="http://test.think.com/Application/Public/Home/images/relate_view2.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="http://test.think.com/Application/Public/Home/images/relate_view3.jpg" alt="" /></a></dt>
						...
						<li>
							<dl>
								<dt><a href=""><img src="http://test.think.com/Application/Public/Home/images/relate_view4.jpg" alt="" /></a></dt>
						...
						<li class="last">
							<dl>
								<dt><a href=""><img src="http://test.think.com/Application/Public/Home/images/relate_view5.jpg" alt="" /></a></dt>
			...
			<div class="viewd leftbar mt10">
				...
				<div class="leftbar_wrap">
					...
					<dl class="last">
						<dt><a href=""><img src="http://test.think.com/Application/Public/Home/images/crazy4.jpg" alt="" /></a></dt>
				...
				<div class="detail_bd">
					...
					<div class="introduce detail_div none">
						...
						<div class="desc mt10">
							...
							<img src="http://test.think.com/Application/Public/Home/images/desc1.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://test.think.com/Application/Public/Home/images/desc2.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://test.think.com/Application/Public/Home/images/desc3.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://test.think.com/Application/Public/Home/images/desc4.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://test.think.com/Application/Public/Home/images/desc5.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://test.think.com/Application/Public/Home/images/desc6.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://test.think.com/Application/Public/Home/images/desc7.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://test.think.com/Application/Public/Home/images/desc8.jpg" alt="" />
							<p style="height:10px;"></p>
							<img src="http://test.think.com/Application/Public/Home/images/desc9.jpg" alt="" />
						</div>
					</div>
					<!-- 商品介绍 end -->
					...
					<div class="comment detail_div mt10">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="http://test.think.com/Application/Public/Home/images/user1.gif" alt="" /></a></dt>
									<dd><a href="">乖乖</a></dd>
								</dl>
							</div>
							<div class="item">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="http://test.think.com/Application/Public/Home/images/user2.jpg" alt="" /></a></dt>
									<dd><a href="">小宝贝</a></dd>
								</dl>
							</div>
							<div class="item">
						...
						<div class="comment_items mt10">
							<div class="user_pic">
								<dl>
									<dt><a href=""><img src="http://test.think.com/Application/Public/Home/images/user3.jpg" alt="" /></a></dt>
									<dd><a href="">天使</a></dd>
								</dl>
							</div>
							<div class="item">
...
<script type="text/javascript" src="http://test.think.com/Application/Public/Home/js/header.js"></script>
	...
	<script type="text/javascript" src="http://test.think.com/Application/Public/Home/js/goods.js"></script>
	<script type="text/javascript" src="http://test.think.com/Application/Public/Home/js/jqzoom-core.js"></script>
