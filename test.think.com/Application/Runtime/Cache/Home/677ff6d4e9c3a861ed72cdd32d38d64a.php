            ...
            <form action="<?php echo U();?>" method="post" id="signupForm">
                <ul>
                    ...
                    <li>
                        ...
                        <input type="text" class="txt tel" name="tel" value="18228435581"/>
...
<script type="text/javascript">
    ...
    $(function () {
        ...
        $('.sendSMS').click(function () {
            ...
            //通过
            $.post("<?php echo U('sendSMS');?>", {tel: val}, function (data) {
                ...
                if (data[0]=='true') {
                    ...
                    //定时器
                    var tmie = 10;
                    var tmies=window.setInterval(function () {
                        $('.sendSMS').val(tmie + '秒后重新发送');
                        tmie--;
                        if(tmie==0){
                        <?php $_SESSION['SMS_CODE'] = 'null'; ?>
                                    d(<?php echo (session('SMS_CODE')); ?>)
                            window.clearInterval(tmies);
